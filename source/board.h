...
#define DISPLAY_MUX_PIN_0   PORTNUM2PIN(PA,1)
#define DISPLAY_MUX_PIN_1   PORTNUM2PIN(PB,9)

#define CARD_DATA   PORTNUM2PIN(PC,7)
#define CARD_CLOCK  PORTNUM2PIN(PC,0)
#define CARD_ENABLE PORTNUM2PIN(PC,9)
